...
if __name__ == "__main__":
    ...
    class _DummyRuleReward:
        """Rule-only reward: bypass the learned reward model; get_score always 0.
        Reward comes solely from rule-based terms in calculate_rewards
        (length / thinking-tag / repetition penalty)."""
        def get_score(self, messages, response):
            return 0.0
    reward_model = _DummyRuleReward()  # rule-based, no internlm2-1_8b-reward needed
